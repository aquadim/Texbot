...
class Bot {
	...
	public function __construct($input) {
		$this->responses = array(
			...
			"get-next-student"=> "Остаётся %s %s до начала пары %s. Начало в %s (%s) (Расписание может отличаться от того, которое на сайте!)",
			"get-next-teacher"=> "Остаётся %s %s до начала пары %s. Начало в %s с группой %s в %s (Расписание может отличаться от того, которое на сайте!)",
